...
public class Rook extends ChessPiece {
    ...
    public boolean moveTo(Position targetPosition) {
        if (isValidMoveTo(targetPosition)) {
    ...
    public boolean isValidMoveTo(Position targetPosition) {
        return !isInvalidMoveTo(targetPosition);
    }
    ...
    private boolean isInvalidOccupiedPosition(Position targetPosition) {
